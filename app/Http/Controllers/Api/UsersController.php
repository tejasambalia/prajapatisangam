...
class UsersController extends Controller
{
  ...
  { 
    ...
    if($data['contact']==""||$data['password']==""){
      return response()->json(array('result' => 'fail', 'message' => 'Please fill contact and password', 'data' => array()), 422);
    }
    else{
      if(strlen($data['contact'])==10&&is_numeric($data['contact'])){
        //generate user_id     
        ...
        return response()->json(array('result' => 'success', 'message' => 'User created successfully. We have send you verification code please verify it', 'data' => array()), 422);
      }
      else{
        return response()->json(array('result' => 'fail', 'message' => 'Please enter proper contact number', 'data' => array()), 422);
      }
    }
  }
