    		...
    		<div id="firstTreeChild">
		    	<div class="row">
		    		<div class="col-md-offset-3 col-md-9">
		                <div class="profile_title_box">
		                    ...
		                    <div class="col-md-3">
		                        {!! Form::text('firstName[]', $data->firstName, array('class' => 'form-control',  'placeholder' => 'First Name *', 'required' => 'required')) !!}
		                    </div>
		                    <div class="col-md-3">
		                        {!! Form::text('middleName[]', $data->middleName, array('class' => 'form-control',  'placeholder' => 'Middle Name *', 'required' => 'required')) !!}
		                    </div>
		                    <div class="col-md-3">
		        ...
		        <div class="row">
		            <div class="col-md-3 profile_left_box">
		                ...
		                {!! Form::date('birthDate[]', $data->birthDate, array('class' => 'form-control',  'placeholder' => '07/10/1994', 'required' => 'required')) !!}
		                ...
		                {!! Form::tel('phone[]', $data->phone, array('class' => 'form-control',  'placeholder' => '9409388600', 'required' => 'required')) !!}
		                <h4 class="profile_sub_title">Email</h4>
		                {!! Form::email('email[]', $data->email, array('class' => 'form-control',  'placeholder' => 'mail@yourdomain.com')) !!}
		                <h4 class="profile_sub_title">Website</h4>
		                {!! Form::text('website[]', $data->website, array('class' => 'form-control',  'placeholder' => 'www.yourdomain.com')) !!}
		                <h4 class="profile_sub_title">Home Town</h4>
		                {!! Form::text('homeTown[]', $data->homeTown, array('class' => 'form-control',  'placeholder' => 'Home Town')) !!}
		                <h4 class="profile_sub_title">Education</h4>
		                {!! Form::text('education[]', $data->education, array('class' => 'form-control',  'placeholder' => 'Education')) !!}
		                <h4 class="profile_sub_title">Occupation</h4>
		                {!! Form::text('occupation[]', $data->occupation, array('class' => 'form-control',  'placeholder' => 'Occupation')) !!}
		            </div>
		            <div class="col-md-9 profile_right_box">
		                ...
		                {!! Form::textarea('about[]', $data->about, array('class' => 'form-control textarea-resize-no',  'placeholder' => 'Write something about your self.
What is your goals? What you have achieve?
Something like that', 'rows' => '3')) !!}
		                <h3 class="profile_title"><span> your thoughts </span></h3>
		                {!! Form::textarea('thoughts[]', $data->thoughts, array('class' => 'form-control textarea-resize-no',  'placeholder' => 'What you are believe in?', 'rows' => '3')) !!}
